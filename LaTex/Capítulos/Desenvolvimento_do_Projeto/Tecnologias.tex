...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{LaTex/Capítulos/img/Desenvolvimento do Projeto/Arquitetura/cliente-servidor.png}
  \caption{Arquitetura Cliente-Servidor.}
  \fonte{Adaptado de Sampaio, G. \textit{Introdução à Arquitetura Cliente-Servidor}. Medium, 2021. }

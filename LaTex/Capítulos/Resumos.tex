...
\noindent
\textbf{Palavras-chave}: Sorveteria. Sistema de Gerenciamento de Estoque. Histórico de vendas. Dashboard.
\end{resumo}
...
\noindent
\textbf{Keywords}: Ice Cream Shop. Inventory Management System. Sales History. Dashboard.
\end{otherlanguage*}
\end{resumo}

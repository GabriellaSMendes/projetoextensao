...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{documentacao/diagrams/Modelo_Conceitual_MER_DER.png}
    \caption{Modelo Conceitual MER DER}
...
\begin{figure}[H]
    ...
    \resizebox{1.1\textwidth}{0.7\textheight}{
        \includegraphics{documentacao\diagrams\Modelo_Conceitual_MER_DER.png}
    }

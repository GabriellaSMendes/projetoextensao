...
BEGIN
    ...
    UPDATE estoque
    SET qtdd_atual = qtdd_atual + OLD.qtdd_venda - NEW.qtdd_venda,
        qtdd_saida = qtdd_saida - OLD.qtdd_venda + NEW.qtdd_venda
    WHERE id_estoque = NEW.id_estoque;
END$$
...
BEGIN
    ...
    SET qtdd_atual = qtdd_atual - OLD.qtdd_recebida + NEW.qtdd_recebida,
        qtdd_entrada = qtdd_entrada - OLD.qtdd_recebida + NEW.qtdd_recebida
    WHERE id_estoque = NEW.id_estoque;
END$$

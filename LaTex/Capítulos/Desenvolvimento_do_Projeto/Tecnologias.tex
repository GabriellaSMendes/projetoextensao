...
A infraestrutura planejada para o sistema Tropical Mix visa garantir estabilidade e segurança ao ambiente de execução da aplicação. Durante o desenvolvimento, a aplicação será executada em ambiente local pelos integrantes da equipe, utilizando servidores Flask para o back-end e o serviço de hospedagem local do React para o front-end.

Para a fase de implantação, considera-se a utilização de um serviço de computação em nuvem, como a \textbf{Amazon Web Services (AWS)} ou o \textbf{Render}, que oferecem planos gratuitos e compatíveis com aplicações em Flask e React. O banco de dados MySQL poderá ser hospedado em serviços como o \textbf{Railway} ou o \textbf{PlanetScale}, garantindo persistência remota e acessibilidade para todos os desenvolvedores.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{LaTex/Capítulos/img/desenvolvimento/cliente-servidor.png}
  \caption{Arquitetura Cliente-Servidor.}
  \fonte{Adaptado de Sampaio, G. \textit{Introdução à Arquitetura Cliente-Servidor}. Medium, 2021. Disponível em: \url{https://medium.com/@kaisergui258/introdu%C3%A7%C3%A3o-a-arquitetura-cliente-servidor-dfae4c0218bd}. Acesso em: 27 out. 2025.}
